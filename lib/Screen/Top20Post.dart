...
class Top20Post extends StatefulWidget {

  const Top20Post({Key? key}) : super(key: key);

  @override
  State<Top20Post> createState() => _Top20PostState();
}

class _Top20PostState extends State<Top20Post> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      try {
        await Provider.of<Posts>(context, listen: false).top20Posts(page: _page).then((value){
          setState(() {
            postData=Provider.of<Posts>(context, listen: false).top20posts;
  ...
  Widget build(BuildContext context) {
    ...
    // final postData=Provider.of<Posts>(context, listen: false).top20posts;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:  Text("Top 20",style:  FormaDJRDisplayBold.copyWith(
