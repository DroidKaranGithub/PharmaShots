...
class EventsPost extends StatefulWidget {

  const EventsPost({Key? key}) : super(key: key);

  @override
  State<EventsPost> createState() => _EventsPostState();
}

class _EventsPostState extends State<EventsPost> {
  ...
  void _loadMore() async {
    if (_hasNextPage == true &&
      ...
      try {
        await Provider.of<Posts>(context, listen: false).eventPosts(page: _page).then((value){
          setState(() {
            postData=Provider.of<Posts>(context, listen: false).eventposts;
  ...
  Widget build(BuildContext context) {
    ...
    // final postData=Provider.of<Posts>(context, listen: false).eventposts;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:Text("Events",style:  FormaDJRDisplayBold.copyWith(
